...
## Corpus Check
- 436 files · ~553,255 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5987 nodes · 11909 edges · 473 communities (286 shown, 187 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 553 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9664572`
...
## Communities (473 total, 187 thin omitted)

### Community 0 - "VEM & Nodal Mesh"
Cohesion: 0.18
Nodes (44): Fun, kP2Mono, kP2Vec, b_from_grads(), char_length(), array, Dynamic, function (+36 more)
...
Cohesion: 0.08
Nodes (31): Delaunay, NearestNeighborSearch, AdaptiveKdTree::AdaptiveKdTree(), AdaptiveKdTree::get_node(), BalancedKdTree::BalancedKdTree(), BalancedKdTree::get_node(), coord_index_t, Delaunay2d::Delaunay2d() (+23 more)

### Community 9 - "CLI Mesh Solve"
Cohesion: 0.05
Nodes (59): mat2, mat3, aligned_3d(), aligned_3d_exact(), angle(), approximate(), CDT2d::create_enclosing_quad(), CDT2d::create_enclosing_triangle() (+51 more)
...
Cohesion: 0.01
Nodes (80): EMSCRIPTEN_KEEPALIVE, InvalidInput, siginfo_t, abnormal_program_termination(), AdaptiveKdTree::create_kd_tree_recursive(), AdaptiveKdTree::new_node(), android_app, BooleanExpression::parse_variable() (+72 more)

### Community 15 - "Structured Mesh Tests"
Cohesion: 0.09
Nodes (28): check_validity, box_hex_mesh(), box_tet_mesh(), cell_corners(), array, uint32_t, uint64_t, Vector3d (+20 more)
...
Cohesion: 0.08
Nodes (31): CG, Dirichlet, dof_values, function, Index, map, SolveMethod, SolveOptions (+23 more)
...
Cohesion: 0.02
Nodes (114): E, Node, absolute_path(), aligned_malloc(), base_name(), BooleanExpression::BooleanExpression(), BooleanExpression::parse_factor(), can_read_directory() (+106 more)

### Community 27 - "Sizing Field Blend"
Cohesion: 0.04
Nodes (101): coord_index_t, int64, Sign, SOSMode, det_3d(), det_3d_exact(), det_3d_filter(), det_4d() (+93 more)
...
Cohesion: 0.13
Nodes (23): Vector3d, runtime_error, ValidityError, array, span, uint32_t, vector, Vector3d (+15 more)
...
Cohesion: 0.08
Nodes (24): array, uint32_t, vector, Vector3d, TriSurface, triangles, validate, vertices (+16 more)

### Community 34 - "Sim Setup Loads"
Cohesion: 0.10
Nodes (18): update_overlays, thread, SimSetup, adapt_leb_waves, adapt_passes, bc_grading, element_tendency, eta_target (+10 more)

### Community 35 - "Kirsch Graded Tests"
Cohesion: 0.12
Nodes (19): Index, SparseMatrix, uint32_t, HpSystem, k, local_sign, local_to_global, mode_nodes (+11 more)

### Community 36 - "P-Elevate Elements"
Cohesion: 0.11
Nodes (35): compute_probes(), compute_scorecard_geom(), compute_solve_health(), count_orphan_nodes(), optional, uint32_t, vector, Vector3d (+27 more)

### Community 37 - "Tet Quality Metrics"
Cohesion: 0.06
Nodes (51): Backend, boundary_residual_placeholder(), bubble_relax(), _clamp01(), _dedupe(), _dist2(), fill_fraction_proxy(), main() (+43 more)
...
Cohesion: 0.04
Nodes (81): interval_nt, CDTBase2d::locate(), CDTBase2d::Tedge_is_Delaunay(), Sign, det_3d(), det_3d_exact(), det_3d_filter(), det_4d() (+73 more)
...
Cohesion: 0.20
Nodes (30): bisector_keep_site(), build_cell(), build_cell_tet(), ConvexCell, pair, size_t, span, vector (+22 more)
...
Cohesion: 0.12
Nodes (32): Dynamic, Matrix, VectorXd, HpShape, dn, n, b_matrix(), build_hex() (+24 more)
...
Cohesion: 0.03
Nodes (52): condition_variable, Periodic, SFrame, CERRStream, mutex, spinlock, ExactCDT2d::create_intersection(), geo_sqr() (+44 more)
...
Cohesion: 0.08
Nodes (27): LoggerClient, SparseBits, BooleanExpression::cur_char(), BooleanExpression::next_char(), Instance, create_directory(), Environment::add_observer(), Environment::notify_local_observers() (+19 more)
...
Cohesion: 0.24
Nodes (13): p, ElementType, Matrix, Stress, vector, Vector3d, VectorXd, poly_vem_constant_strain() (+5 more)
...
Cohesion: 0.06
Nodes (33): AccuracyInfo, metric, rel_err, truth, value, AnswersInfo, load_area_rel_err, load_face_area (+25 more)

### Community 94 - "Schema Label Field"
Cohesion: 0.10
Nodes (10): string, array, vector, unit_cube(), base_signal(), box(), path, unique_temp_vtu() (+2 more)
...
Cohesion: 0.07
Nodes (29): COORD, MESH, MeshElementsFlags, MeshOrder, Base_ccmp, Base_fcmp, Base_tcmp, BooleanExpression::operator()() (+21 more)
...
Cohesion: 0.11
Nodes (20): GradedSizing, size_at, sources_, vector, Vector3d, SeedPlan, h_fine, refine_seeds (+12 more)
...
Cohesion: 0.11
Nodes (21): IT, CMP, ITERATOR, HilbertSort3d, m0_, m1_, m2_, m3_ (+13 more)
...
Cohesion: 0.09
Nodes (15): DWORD, ExactPoint, LPVOID, std::vector<bool>, ThreadGroup, ExactCDT2d::add_point(), ExactCDT2d::create_enclosing_quad(), ExactCDT2d::create_enclosing_triangle() (+7 more)
...
Cohesion: 0.07
Nodes (30): CampaignResources, max_mem_gb, max_threads, CampaignScoreWeights, accuracy, mesh_ms, solve_ms, CampaignSpec (+22 more)
...
Cohesion: 0.06
Nodes (51): COORD_T, ConvexCell::barycenter(), ConvexCell::compute_mg(), ConvexCell::compute_triangle_point(), ConvexCell::facet_area(), ConvexCell::squared_inner_radius(), ConvexCell::squared_radius(), ConvexCell::volume() (+43 more)
...
Cohesion: 0.03
Nodes (49): CellStatusArray, capacity_, cell_status_, MAX_THREADS, atomic, cell_status_t, Delaunay3d::show_list(), Delaunay3d::show_tet_adjacent() (+41 more)
...
Cohesion: 0.08
Nodes (30): CadEdgeFeature, CadSurfaceKind, CadEdge, dihedral_rad, feature, id, kappa_samples, length (+22 more)
...
Cohesion: 0.07
Nodes (32): ConstrainedLloydParams, lloyd, project_each_iter, project_final, seed, sharp_guard_frac, wall_band_frac, ConstrainedLloydResult (+24 more)
...
Cohesion: 0.06
Nodes (33): A1, A2, DIM, DIM2, T, T1, T2, vector_type (+25 more)
...
Cohesion: 0.20
Nodes (10): ElementHpSignal, eta, h, hex_fit, kappa, p_max, poly_fit, surplus (+2 more)
...
Cohesion: 0.13
Nodes (31): CadTopology, edges, faces, vertices, chordal_edge_metrics(), chordal_edge_metrics_segments(), classify_edges(), closest_edge() (+23 more)
...
Cohesion: 0.06
Nodes (77): set, atomic_write(), Box3, hi, lo, cfg_id_of(), Checkpoint, campaign (+69 more)
...
Cohesion: 0.18
Nodes (12): QuadKey, array, size_t, uint32_t, elem_quad(), elem_tri(), map_tet_face_mode(), quad_key() (+4 more)
...
Cohesion: 0.05
Nodes (46): Attribute, FILE, global_index_t, IncidentTetrahedra, ostream, size_t, BalancedKdTree::build_tree(), barycenter() (+38 more)
...
Cohesion: 0.20
Nodes (20): CvtLloydParams, h_floor, max_iters, move_tol_rel, size_at, SizeFieldFn, bisector_keep_site(), build_rvd_cell() (+12 more)

### Community 353 - "elem_quad"
Cohesion: 0.10
Nodes (22): ConvexCellFlags, Frame, begin_task(), cancel(), ConvexCell::compute_geometry(), ConvexCell::ConvexCell(), ConvexCell::triangulate_conflict_zone(), ushort (+14 more)
...
Cohesion: 0.22
Nodes (12): b_matrix(), Dynamic, Matrix, MatrixXd, element_coords(), element_stiffness(), HexRecipe, i (+4 more)
...
Cohesion: 0.17
Nodes (16): fit, array, DisplayMode, optional, uint32_t, vector, Vector3d, fea_colormap() (+8 more)

### Community 370 - "solve_l"
Cohesion: 0.04
Nodes (55): RadialMap, BenchError, map, runtime_error, string, ReferenceCase, citation, name (+47 more)
...
Cohesion: 0.19
Nodes (5): CDTBase2d::insert(), CDTBase2d::insert_constraint(), Delaunay2d::insert(), Delaunay3d::insert(), OK()
...
Cohesion: 0.10
Nodes (20): Entity, HpMode, edge_odd, entity, entity_index, index0, index1, index2 (+12 more)
...
Cohesion: 0.12
Nodes (18): Delaunay2d::check_geometry(), Delaunay2d::create_first_triangle(), Delaunay2d::find_conflict_zone(), Delaunay2d::locate(), Delaunay2d::locate_inexact(), Delaunay2d::nearest_vertex(), Delaunay3d::locate(), Delaunay3d::locate_inexact() (+10 more)
...
Cohesion: 0.12
Nodes (21): empty, optional, Model, bbox_max, bbox_min, cad, name, region_count (+13 more)
...
Cohesion: 0.06
Nodes (43): aligned_3d(), aligned_3d_exact(), det2x2(), det3x3(), det4x4(), geo_argused(), geo_clamp(), geo_cmp() (+35 more)
...
Cohesion: 0.06
Nodes (29): function_pointer, aligned_allocator, ALIGNMENT, aligned_free(), A2, const_pointer, const_reference, FPTR (+21 more)
...
Cohesion: 0.12
Nodes (18): array, map, uint32_t, join_worker, note_mesh_stats, VolumeMeshOutput, boundary_node_region, boundary_quads (+10 more)
...
Cohesion: 0.16
Nodes (22): compress_expansion(), expansion(), expansion::compare(), expansion::is_same_as(), expansion::optimize(), fast_expansion_diff_zeroelim(), fast_expansion_sum_zeroelim(), fast_two_sum() (+14 more)
...
Cohesion: 0.25
Nodes (8): arg_matches(), Line, desc, name, value, load_config(), parse_config_file(), parse_internal()
...
Cohesion: 0.15
Nodes (14): Delaunay2d::check_combinatorics(), Delaunay3d::check_combinatorics(), Delaunay3d::check_geometry(), Delaunay3d::create_first_tetrahedron(), Delaunay3d::show_tet(), Delaunay3d::stellate_cavity(), Delaunay3d::stellate_conflict_zone_iterative(), facet_facet() (+6 more)
...
Cohesion: 0.09
Nodes (36): BoxSel, hi, lo, cmd_check(), cmd_diag(), cmd_mesh(), cmd_solve(), size_t (+28 more)
...
Cohesion: 0.13
Nodes (16): atomic, size_t, vector, Vector3d, RefinementPlan, h_fine, n_bc_seeds, n_geometry_seeds (+8 more)

### Community 427 - "prism_fill_surface"
Cohesion: 0.50
Nodes (4): EdgeKey, edge_key(), EdgeKeyHash, elem_edge()
...
Cohesion: 0.07
Nodes (39): KeepInitialValues, local_index_t, NearestNeighbors, AdaptiveKdTree::build_tree(), AdaptiveKdTree::split_kd_node(), BalancedKdTree::best_splitting_coord(), BalancedKdTree::split_kd_node(), ComparePointCoord (+31 more)
...
## Knowledge Gaps
- **1955 isolated node(s):** `energy`, `free_dofs`, `nnodes`, `nelems`, `mesh_s` (+1950 more)
...
- **Why does `set` connect `element_stiffness` to `VEM & Nodal Mesh`, `Element Assembly Core`, `HandoffInfo`, `Poly Mesh Topology`, `Pipeline Scene Jobs`, `Structured Mesh Tests`, `Mixed Cell Fill`, `solve`, `GUI Widgets`, `Transition Fill`, `Geom Indicators`, `VtuPointData`, `Sim Setup Loads`, `TriSurface Geometry`, `Holdout geometry audits`, `Local Refine Tests`, `Tet Fill Tests`, `GroupBox Frame UI`, `Schema Label Field`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Delaunay3dThread` connect `schema_version` to `elem_quad`, `test_quadrature.cpp`, `ZZ Recovery API`, `Pipeline Scene Jobs`, `VertexArray`, `ClosestOnFeature`, `test_d6_bench_smoke.cpp`, `cad_topology.cpp`, `Viewport Camera`, `element_stiffness`, `CurvedMeshMetrics`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `ProbeAnswers` connect `MetricSpec` to `element_stiffness`, `P-Elevate Elements`?**
