...
|---|---|---|---|---|---|
| relative error | 0 → 0 | 0.917 → **0.869** | 1.031 → 0.970 | 0.596 → 0.661 | 0.618 → 0.645 |
| relative error x degrees of freedom | 0.362 → 0.426 | 1.194 → 1.141 | 0.923 → 0.966 | 1.063 → 1.267 | 1.541 → 1.708 |
| mesh-to-CAD worst 1% | 0.698 → **0.288** | 1.356 → **0.491** | 1.286 → **0.146** | 0.086 → 0.047 | 0.058 → 0.059 |
| solve time | 2.049 → 1.962 | 2.033 → 1.886 | 1.230 → 1.236 | 2.300 → 2.405 | 2.977 → 3.079 |
