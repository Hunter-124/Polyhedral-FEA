...
| `gallery_sphere.png` | Closed curved B-rep; stair-cased Cartesian fill with feature-graded skin (h = 8 mm, 4,646 / 22,698, 13,938 DOF) | solve VTU, `tests/fixtures/parts/sphere.step`; `render_showcase.py --only sphere` |
