...
All figures below are measured on the **rebuilt** corpus: 2,412 rows, dataset
SHA-256 `3c0d6bd7a7d3…`, references from an independent Gmsh + CalculiX chain
(88 external, 8 closed-form) with evidence-derived tolerances near 0.02.
