...
**Currency, 2026-08-14.** The shipped artifact is the v4 model:
`bench/advisor/dataset.csv`, **2,752 rows**, sha256 `c015b57eeb61a5aa0081…`,
`runs/best.pt` run 143, ONNX 62 input columns / 17,617 parameters, parity
2.2e-06. References are an independent Gmsh + CalculiX chain (176 external, 12
closed-form) plus, for the fixture parts, the hand-calcs in
`docs/validation/hand-calcs.md`. Decision numbers live in
`bench/advisor/crossval_v4.json`.
...
[0008](0008-v4-corpus-retrain.md) (v4 corpus, current decision numbers).
